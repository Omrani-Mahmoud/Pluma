...
function FacebookPrimaryTextForm({languages}) {
    ...
    const handleChange = (event) => {
      ...
      const _getResults = ()=>{
        ...
        axios.post(`${uri.link}/fbtext/${req}`,body,{headers: 
               ...
               <FormControlLabel
                ...
                <label for="scales">More options</label> */}
                {
                    ...
                    <div>
                        ...
                        <CustomInput length={20} v={formValue.promotion} name='promotion' placeholder='ex. 20% off'  margin={30}  action={dispatch} type='promotion'/>
