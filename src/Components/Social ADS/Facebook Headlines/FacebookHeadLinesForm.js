...
function FacebookHeadLinesForm({languages}) {
    ...
    const _getResults = ()=>{
        ...
        axios.post(`${uri.link}/facebh/${req}`,body,{headers: 
    ...
    return (
        <Grid item md={12} xs ={12} style={{padding:'20px'}}>
            <CustomSnackbar
              ...
              <CustomTextArea length={70} v={formValue.desc} action={dispatch} type='desc'/>
              <VoiceToneList />
               <FormControlLabel
                ...
                <label for="scales">More options</label> */}
                {
                    ...
                    <div>
                        ...
                        <CustomInput length={50} v={formValue.promotion} name='promotion' placeholder='ex. 20% off'  margin={30}  action={dispatch} type='promotion'/>
